...
- **[`coverage/`](coverage/README.md)** — `llvm-cov` source-based coverage via the `//coverage:reporter` target and `score_coverage_reporter` macro, with a shared baseline of ignore regexes and an effective-coverage justification post-processor.
